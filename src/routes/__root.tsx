...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Quintana Food — Delivery de comida" },
      { name: "description", content: "Peça comida das melhores lojas da sua região com pagamento Pix, cartão ou na entrega." },
      { property: "og:title", content: "Quintana Food" },
      { property: "og:description", content: "Delivery de comida da sua cidade." },
