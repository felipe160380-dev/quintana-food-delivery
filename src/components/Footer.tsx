  ...
  return (
    <footer className="mt-10 border-t bg-card">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <div className="mb-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Trabalhe conosco</div>
          <ul className="space-y-2 text-sm">
            <li><Link to="/tornar-se-lojista" className="hover:text-primary">Cadastre sua loja</Link></li>
            <li><Link to="/tornar-se-entregador" className="hover:text-primary">Seja entregador</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 text-xs text-muted-foreground">Pagamento Pix, cartão pelo app ou na entrega.</p>
        </div>
      </div>
      <div className="border-t">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-muted-foreground sm:flex-row">
          <div>© {new Date().getFullYear()} Quintana Food. Todos os direitos reservados.</div>
